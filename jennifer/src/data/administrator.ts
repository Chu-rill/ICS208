...
export const generateSystemSettings = (): SystemSettings[] => {
  return [
    // General settings
    {
      ...
      description:
        "Official name of the system displayed in headers and reports",
      category: "general",
      type: "string",
    },
    {
  ...
  return [
    {
      ...
      description:
        "Industrial training program for Computer Science and IT students focusing on software development, systems analysis, and IT infrastructure management.",
      duration: 6,
      durationUnit: "months",
      departments: [
        "Computer Science",
    ...
    },
    {
      ...
      description:
        "Comprehensive industrial training for engineering students across various disciplines, focusing on practical engineering applications and project management.",
      duration: 6,
      durationUnit: "months",
      departments: [
    ...
    },
    {
      ...
      description:
        "Industrial attachment program for business administration and management students, focusing on practical business operations, management, and administration.",
      duration: 3,
      durationUnit: "months",
      departments: [
    ...
    },
    {
      ...
      description:
        "Clinical and practical experience program for healthcare students, focusing on patient care, clinical procedures, and healthcare management.",
      duration: 4,
      durationUnit: "months",
      departments: [
        "Medicine",
    ...
    },
    {
      ...
      description:
        "Field experience program for agricultural science students, focusing on modern farming techniques, agricultural research, and agribusiness management.",
      duration: 5,
      durationUnit: "months",
      departments: [
...
export const generateAnnouncements = (): Announcement[] => {
  ...
  return [
    ...
    },
    {
      ...
      content:
        "The SIWES Management System will undergo scheduled maintenance on April 25th, 2023, from 10:00 PM to 2:00 AM. During this time, the system will be inaccessible. Please ensure any urgent submissions or reviews are completed before the maintenance window. We apologize for any inconvenience this may cause and appreciate your understanding as we work to improve system performance and security.",
      author: "Aisha Bello",
      authorId: "10",
      audiences: ["all"],
      priority: "medium",
